...
layui.define(["layer", "laytpl", "element"],
    function(i) {
        ...
        i("navbar",
        {
            ...
            hasElem: function() {
                var i = this.config;
                return void 0 !== i.elem ||
                    0 !== t.find("ul[kit-navbar]").length ||
                    !e(i.elem) ||
                    (layui.hint().error("Navbar error:请配置Navbar容器."), !1);
            },
            getElem: function() {
                var i = this.config;
            ...
            bind: function(i, n) {
                ...
                return e.extend(!0, d, n), (void 0 === d.target ? t : e(d.target)).find("a[kit-target]")
                    .each(function() {
                        var t = e(this), n = void 0;
                        d.showTips &&
                            t.hover(function() { n = a.tips(e(this).children("span").text(), this) },
                                function() { n && a.close(n) }), t.off("click").on("click",
                            function() {
                    ...
                    function() {
                        ...
                        i.hasClass("kit-sided")
                            ? (i.removeClass("kit-sided"), t.find("div.layui-body").removeClass("kit-body-folded"), t
                                .find("div.layui-footer").removeClass("kit-footer-folded"))
                            : (i.addClass("kit-sided"), t.find("div.layui-body").addClass("kit-body-folded"), t
                                .find("div.layui-footer").addClass("kit-footer-folded"));
                    }), l;
            },
            render: function(i) {
                var t = this,
                    ...
                    o = d.remote,
                    r = [
                        "{{# layui.each(d,function(index, item){ }}", "{{# if(item.spread){ }}",
                ...
                if (void 0 !== d.data && d.data.length > 0) c = d.data;
                    ...
                    var u = {
                        url: o.url,
                        type: o.type,
                        error: function(i, e, t) { layui.hint().error("Navbar error:AJAX请求出错." + t), s && a.close(s) },
                        success: function(i) { c = i }
                    };
                    e.extend(!0,
                        u,
                        o.jsonp
                ...
                var h = setInterval(function() {
                        c.length > 0 &&
                        (clearInterval(h), n(r.join("")).render(c,
                            function(e) {
                                f.html(e), l.init(), t
                                    .bind(function(e) { "function" == typeof i && i(e) }), s && a.close(s)
                            }));
                    },
                    50);
                return t;
