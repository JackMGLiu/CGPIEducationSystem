         ...
         !function(t) {
             ...
             function a(e, n, a) {
                 ...
                 if (!(e.which > 1 ||
                     ...
                     r.href.indexOf("#") > -1 && m(r) == m(location) ||
                     e.isDefaultPrevented())) {
                     var i = { url: r.href, container: t(r).attr("data-pjax"), target: r },
                         s = t.extend({}, i, a),
                         c = t.Event("pjax:click");
                     t(r).trigger(c, [s]), c.isDefaultPrevented() ||
                         (o(s), e.preventDefault(), t(r).trigger("pjax:clicked", [s]));
                 }
             }
             ...
             function r(e, n, a) {
                 ...
                 ) i.data = new FormData(r), i.processData = !1, i.contentType = !1;
                 else {
             ...
             function o(e) {
                 ...
                 e.data || (e.data = {}), t.isArray(e.data)
                     ? e.data.push({ name: "_pjax", value: i.selector })
                     : e.data._pjax = i.selector;
                 var c;
                 e.beforeSend = function(t, a) {
                     if ("GET" !== a.type && (a.timeout = 0), t.setRequestHeader("X-PJAX", "true"), t
                         .setRequestHeader("X-PJAX-Container", i.selector), !n("pjax:beforeSend", [t, a])) return!1;
                     a.timeout > 0 &&
                     (c = setTimeout(function() { n("pjax:timeout", [t, e]) && t.abort("timeout") }, a.timeout), a
                         .timeout = 0);
                     var o = h(a.url);
                     ...
                     var l = o.state,
                         f = "function" == typeof t.pjax.defaults.version
                     ...
                     if (r && (v.hash = r, m.url = v.href), f && d && f !== d) s(m.url);
                         ...
                         m
                             .title &&
                             (document.title = m.title), n("pjax:beforeReplace",
                             [m.contents, e],
                             { state: o.state, previousState: l }), i.html(m.contents);
                 ...
                 return u.readyState > 0 &&
                 (e
                     .push &&
                     !e.replace &&
                     (b(o.state.id, f(i)), window.history
                         .pushState(null, "", e.requestUrl)), n("pjax:start", [u, e]), n("pjax:send", [u, e])), o.xhr
             }
             ...
             function s(t) { window.history.replaceState(null, "", o.state.url), window.location.replace(t) }
             ...
             function u(e) {
                 ...
                 if ("string" == typeof o)
                     ...
                     t.each(o,
                         function(e, n) { r.append(t("<input>", { type: "hidden", name: n.name, value: n.value })) });
             ...
             function l(e) { e && e.readyState < 4 && (e.onreadystatechange = t.noop, e.abort()) }

             function p() { return(new Date).getTime() }

             function f(t) {
                 var n = t.clone();
                 return n.find("script")
                     .each(function() { this.src || e._data(this, "globalEval", !1) }), [t.selector, n.contents()];
             }
             ...
             function m(t) { return t.href.replace(/#.*/, "") }

             function v(e, n) {
                 return e && n ? n.container = e : n = t.isPlainObject(e) ? e : { container: e },
             ...
             function g(t, e) { return t.filter(e).add(t.find(e)) }

             function j(e) { return t.parseHTML(e, document, !0) }

             function y(e, n, a) {
                 var r = {}, o = /<html/i.test(e), i = n.getResponseHeader("X-PJAX-URL");
                 if (r.url = i ? d(h(i)) : a.requestUrl, o)
                     var s = t(j(e.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0])),
                 ...
                 if (r.title = g(s, "title").last().text(), a.fragment) {
                     ...
                     u.length &&
                     (r
                             .contents = "body" === a.fragment ? u : u.contents(),
                         r.title || (r.title = u.attr("title") || u.data("title")));
                 } else o || (r.contents = c);
                 return r.contents &&
                 (r.contents = r.contents.not(function() { return t(this).is("title") }), r.contents.find("title")
                     .remove(), r.scripts = g(r.contents, "script[src]").remove(), r.contents = r.contents
             ...
             function w(e) {
                 if (e) {
                     ...
                     e.each(function() {
                         var e = this.src;
                         if (!n.filter(function() { return this.src === e }).length) {
             ...
             function b(t, e) { R[t] = e, X.push(t), E(U, 0), E(X, o.defaults.maxCacheLength) }

             function T(t, e, n) {
                 var a, r;
                 R[e] = n, "forward" === t ? (a = X, r = U) : (a = U, r = X), a
                     .push(e), (e = r.pop()) && delete R[e], E(a, o.defaults.maxCacheLength);
             }

             function E(t, e) { for (; t.length > e;) delete R[t.shift()] }
             ...
             function P() {
                 t.fn.pjax = n, t.pjax = o, t.pjax.enable = t.noop, t.pjax.disable = C, t.pjax.click = a, t.pjax
                     .submit = r, t.pjax.reload = i, t.pjax
                     .defaults = {
                         timeout: 650,
                         push: !0,
                         replace: !1,
             ...
             function C() {
                 t.fn.pjax = function() { return this }, t.pjax = u, t.pjax.enable = P, t.pjax.disable = t.noop, t.pjax
                     .click = t.noop, t.pjax.submit = t.noop, t.pjax
                     .reload = function() { window.location.reload() }, t(window).off("popstate.pjax", c);
             }

             var A = !0, q = window.location.href, D = window.history.state;
             D && D.container && (o.state = D), "state" in window.history && (A = !1);
             var R = {}, U = [], X = [];
             t.inArray("state", t.event.props) < 0 && t.event.props.push("state"), t.support
                 .pjax = window.history &&
                 window.history.pushState &&
                 window.history.replaceState &&
                 !navigator.userAgent
                 .match(/((iPod|iPhone|iPad).+\bOS\s+[1-4]\D|WebApps\/.+CFNetwork)/), t.support.pjax ? P() : C();
         }(e), t("pjax");
     });