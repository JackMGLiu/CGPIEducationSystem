     ...
     function(e) {
         ...
         var t = layui.$,
             ...
             d = {
                 ...
                 on: function(e, t) { return layui.onevent.call(this, s, e, t) }
             },
             c = function() {
         ...
         H.prototype.config = { limit: 20, loading: !0 }, H.prototype.render = function(e) {
             var a, l = this;
             if (e && (l.config = e), a = l.config, a.elem = t(a.elem), a.where = a.where || {}, a.request = t
                 .extend({ pageName: "page", limitName: "limit" }, a.request), a.response = t
                 .extend({ statusName: "code", statusCode: 0, msgName: "msg", dataName: "data", countName: "count" },
             ...
             if (a.index = l.index, o[0] && o.remove(), n.after(r), l.layHeader = r.find(p), l.layMain = r.find(v), l
                 .layBody = r.find(m), l.layFixed = r.find(g), l.layFixLeft = r.find(x), l.layFixRight = r.find(b), l
                 .layTool = r.find(k), a.height && l.fullSize(), a.cols.length > 1) {
                 var d = l.layFixed.find(p).find("th");
                 d.height(l.layHeader.height() -
                     1 -
             ...
             if (n.url) {
                 var c = {};
                 c[o.pageName] = e, c[o.limitName] = n.limit, t
                     .ajax({
                         type: n.method || "get",
                         url: n.url,
                         ...
                         success: function(t) {
                             return t[r.statusName] != r.statusCode
                                 ? (a.renderForm(), a.layMain
                                     .html('<div class="' + h + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>"))
                                 : (a
                                     .renderData(t, e, t[r.countName]), d(), i && l.close(i), void(
                 ...
                 s[r.dataName] = n.data.concat().splice(u, n.limit), s[r.countName] = n.data.length, a
                     .renderData(s, e, n.data.length), d(), "function" == typeof n.done && n.done(s, e, s[r.countName]);
             }
                 ...
                 function(e, t) {
                     layui.each(t,
                         function(t, n) {
                             if (n.colspan > 1) {
                                 var o = 0;
                                 l++, n.CHILD_COLS = [], layui
                                     .each(i[e + 1],
                                         function(e, t) {
                                             t.PARENT_COL ||
                                                 o == n.colspan ||
                                                 (t.PARENT_COL = l, n.CHILD_COLS
                                                     .push(t), o += t.colspan > 1 ? t.colspan : 1);
                                         });
                             }
             ...
             var n = function(t) {
                 layui.each(t || a, function(t, i) { return i.CHILD_COLS ? n(i.CHILD_COLS) : void e(t, i) });
             };
             n();
                     ...
                     return!r && c.sortKey
                         ...
                         : (layui.each(u,
                             function(e, a) {
                                 var l = [], n = [], o = [];
                                 0 !== a.length &&
                                 (r || (a[d.config.indexName] = e), c.eachCols(function(e, r) {
                                     var c = a[r.field || e];
                                             ...
                                             function() {
                                                 ...
                                                 return r
                                                     ...
                                                     r
                                                         .event &&
                                                         e
                                                         .push(' lay-event="' + r.event + '"'),
                                                     r.style && e.push(' style="' + r.style + '"'), e.join("");
                                             }() +
                                             ">", '<div class="layui-table-cell laytable-cell-' +
                                             function() {
                                                 return r.checkbox
                                                     ? "checkbox"
                                                     : r.space ? "space" : s.index + "-" + (r.field || e);
                                             }() +
                                             '">' +
                                             function() {
                                                 return r.checkbox
                                                     ...
                                                     : r.templet ? i(t(r.templet).html() || String(c)).render(a) : c;
                                             }(), "</div></td>"
                                         ].join("");
                                         l.push(u), r
                                             .fixed &&
                                             "right" !== r.fixed &&
                                             n.push(u), "right" === r.fixed && o.push(u);
                                     }
                                 }), f.push('<tr data-index="' + e + '">' + l.join("") + "</tr>"), y
                                     .push('<tr data-index="' + e + '">' + n.join("") + "</tr>"), p
                                     .push('<tr data-index="' + e + '">' + o.join("") + "</tr>"));
                             }), c.layBody.scrollTop(0), c.layMain.find("." + h).remove(), c.layMain.find("tbody")
                             .html(f.join("")), c.layFixLeft.find("tbody").html(y.join("")), c.layFixRight.find("tbody")
                             .html(p.join("")), c.renderForm(), c
                             .syncCheckAll(), c.haveInit
                             ? c.scrollPatch()
                             : setTimeout(function() { c.scrollPatch() }, 50), c
                             .haveInit = !0, void l.close(c.tipsIndex));
                 };
             return c.key = s.id || s.index, d.cache[c
                 .key] = u, r
                 ? m()
                 : 0 === u.length
                 ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + h)
                     .remove(), c.layMain.append('<div class="' + h + '">无数据</div>'))
                 : (m(), void(s.page &&
                 (c.page = n, c.count = o, a.render({
                     ...
                     jump: function(e, t) { t || (c.page = e.curr, s.limit = e.limit, c.pullData(e.curr, c.loading())) }
                 }), c.layTool.find(".layui-table-count span").html(o))));
         }, H.prototype.renderForm = function(e) { n.render(e || "checkbox", "LAY-table-" + this.index) }, H.prototype
             .sort = function(e, i, a, n) {
                 ...
                 try {
                     ...
                     u.layHeader.find("th").find(C).removeAttr("lay-sort"), m.attr("lay-sort", i || null), u.layFixed
                         .find("th");
                 } catch (v) {
                     return o.error("Table modules: Did not match to field");
                 }
                 u.sortKey = { field: r, sort: i }, "asc" === i
                         ? c = layui.sort(p, r)
                         : "desc" === i
                         ? c = layui.sort(p, r, !0)
                         : (c = layui.sort(p, d.config.indexName), delete u.sortKey),
                     f[h.response.dataName] = c, u.renderData(f, u.page, u.count, !0), l
                         .close(u.tipsIndex), n && layui.event.call(e, s, "sort(" + y + ")", { field: r, type: i });
             ...
             layui.each(n,
                 function(a, l) { if (l.selectorText === ".laytable-cell-" + i.index + "-" + e) return t(l), !0 });
         }, H.prototype.fullSize = function() {
             var e, t = this, i = t.config, a = i.height;
             t
                     .fullHeightGap &&
                     (a = L.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem
                         .css("height", a)), e = parseFloat(a) - parseFloat(t.layHeader.height()) - 1,
                 i.page && (e -= parseFloat(t.layTool.outerHeight() + 1)), t.layMain.css("height", e);
             ...
             e.layFixed.find(m).css("height", i.height() > r ? r : "auto"), e
                 .layFixRight[i.width() > e.layMain.width() ? "removeClass" : "addClass"](f), e.layFixRight
                 .css("right", a - 1);
             ...
             u.on("mousemove",
                 ...
                 function(e) {
                     if (c.allowResize) {
                         ...
                         e.preventDefault(), c.resizeStart = !0, c.offset = [e.clientX, e.clientY], a
                             .getCssRule(i, function(e) { c.rule = e, c.ruleWidth = parseFloat(e.style.width) });
                     }
                 }), S.on("mousemove",
                 function(t) {
                     if (c.resizeStart) {
                 ...
                 function() {
                     ...
                     o
                         ? (i.each(function(e, t) { t.checked = n, a.setCheckData(e, n) }), a.syncCheckAll(), a
                             .renderForm())
                         : (a.setCheckData(l, n), a.syncCheckAll()), layui.event
                         .call(this,
                             s,
                             "checkbox(" + h + ")",
                             { checked: n, data: d.cache[a.key][l], type: o ? "all" : "one" });
                 }), a.layBody.on("mouseenter",
                 "tr",
                 function() {
                 ...
                 function() {
                     var e,
                         ...
                         r = d.cache[a.key][o];
                     a.eachCols(function(t, i) { i.field == n && i.templet && (e = i.templet) }), l.siblings(f)
                         .html(e ? i(t(e).html() || this.value).render(r) : this.value), l.parent()
                         .data("content", this.value), l.remove();
                 }), a.layBody.on("click",
                 "td",
                 function() {
                     ...
                     if (!e.data("off")) {
                         if (e.data("edit")) {
                             ...
                             return o[0].value = e.data("content") || i.text(), e.find("." + w)[0] || e.append(o), o
                                 .focus();
                         }
                         ...
                         (a.tipsIndex = l.tips([
                                 ...
                                 '">', i.html(), "</div>", '<i class="layui-icon layui-table-tips-c">&#x1006;</i>'
                             ].join(""),
                             i[0],
                             {
                                 tips: [3, ""],
                                 ...
                                 success: function(e, t) {
                                     e.find(".layui-table-tips-c").on("click", function() { l.close(t) });
                                 }
                             }));
                     }
                 }), a.layBody.on("click",
                                 ...
                                 e = e || {}, layui.each(e,
                                     function(e, l) {
                                         if (e in r) {
                                             ...
                                             r[e] = l, a
                                                     .eachCols(function(t, i) {
                                                         i.field == e && i.templet && (o = i.templet);
                                                     }),
                                                 d.children(f).html(o ? i(t(o).html() || l).render(r) : l), d
                                                     .data("content", l);
                                         }
                                     });
                             }
                 ...
                 }), L.on("resize", function() { a.fullSize(), a.scrollPatch() });
         }, d.init = function(e, i) {
             i = i || {};
             var a = this,
             ...
             return a
                 ? (layui
                         .each(a, function(e, a) { a[d.config.checkName] && (t++, i.push(d.clearCacheKey(a))) }),
